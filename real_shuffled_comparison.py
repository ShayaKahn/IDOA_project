...
real = pd.read_excel('Saliva.xlsx', header=None)
...
layout = go.Layout(
    xaxis=dict(
        ...
        showgrid=False,
        linewidth=4,
        titlefont=dict(family="Arial", size=60),
    ...
    barmode='overlay',
    legend=dict(x=0, y=1, font=dict(size=50, family="Arial")),
    width=1200,
    height=1200,
    plot_bgcolor='white'
)
...
layout = go.Layout(
    ...
    barmode='overlay',
    legend=dict(x=0.7, y=1, font=dict(size=50, family="Arial")),
    width=1200,
    height=1200,
    plot_bgcolor='white'
)
